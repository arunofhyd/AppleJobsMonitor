...
scratch = "/Users/arunthomas/.gemini/antigravity-ide/scratch"
jobs_png_path = "/Users/arunthomas/Downloads/jobsmonitor/Jobs.png"

with open("/Users/arunthomas/.gemini/antigravity-ide/scratch/main.swift", "r", encoding="utf-8") as f:
    swift_code = f.read()

# Encode Swift source and Jobs.png as base64 strings so JobsMonitor.command is 100% standalone!
...
def cleanup_old_install():
    ...
    old_plist = home / "Library/LaunchAgents/com.arunthomas.applejobsmonitor.plist"
...
with open("/Users/arunthomas/.gemini/antigravity-ide/scratch/JobsMonitor.command", "w", encoding="utf-8") as f:
    f.write(command_content)

with open("/Users/arunthomas/Downloads/jobsmonitor/JobsMonitor.command", "w", encoding="utf-8") as f:
    f.write(command_content)

os.chmod("/Users/arunthomas/.gemini/antigravity-ide/scratch/JobsMonitor.command", 0o755)
os.chmod("/Users/arunthomas/Downloads/jobsmonitor/JobsMonitor.command", 0o755)

print("Generated standalone JobsMonitor.command script successfully!")
